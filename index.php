			...
			<div class="menu">
				<div class="menu_stroka">
					<a class="menu_big_element" href="Character.php">
						...
						<div class="element_title">Персонажи</div>
					...
					<a class="menu_big_element" href="#">
						...
						<div class="element_title">Читать</div>
					...
					<a class="menu_big_element" href="#">
						...
						<div class="element_title">Локации</div>
						<div class="element_center_text">В даэстре много мест, каждое из которых уникально чем-то своим</div>
					</a>
				</div>
				<div class="menu_stroka">
					<a class="menu_big_element" href="#">
					...
					<a class="menu_big_element" href="#">
						...
						<div class="element_title">События</div>
						<div class="element_center_text">Слухи, документы, легенды...</div>
					</a>
				</div>
			</div>
		</div>
